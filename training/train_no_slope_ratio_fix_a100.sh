#!/bin/bash
#SBATCH --job-name=varunanet_no_slope_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_no_slope_a100.sh, job 1710,
# 0.4134 mean IoU under the broken ratio channel + stale normalization stats.
