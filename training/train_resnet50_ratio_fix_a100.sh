#!/bin/bash
#SBATCH --job-name=varunanet_resnet50_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_resnet50_a100.sh, job 1786,
# 0.3966 mean IoU under the broken ratio channel + stale normalization stats.
