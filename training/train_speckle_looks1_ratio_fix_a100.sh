#!/bin/bash
#SBATCH --job-name=varunanet_speckle_looks1_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_speckle_looks1_a100.sh, job 1731,
# 0.4060 mean IoU under the broken ratio channel + stale normalization stats.
