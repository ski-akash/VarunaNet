#!/bin/bash
#SBATCH --job-name=varunanet_speckle_looks4_s2_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_speckle_looks4_s2_a100.sh, job 1753,
# 0.4271 mean IoU under the broken ratio channel + stale normalization stats.
