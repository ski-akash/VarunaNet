#!/bin/bash
#SBATCH --job-name=varunanet_resnet18_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_resnet18_a100.sh, job 1941,
# 0.4142 mean IoU under the broken ratio channel + stale normalization stats.
