#!/bin/bash
#SBATCH --job-name=varunanet_speckle_looks4
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# Speckle-noise augmentation sweep, moderate noise (looks=4 -- this
# project's DatasetConfig default). Same recipe as the real baseline
