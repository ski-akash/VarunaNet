#!/bin/bash
#SBATCH --job-name=varunanet_segformer_b2_ratio_fix
#SBATCH --output=%j.out
#SBATCH --error=%j.err
...
# for the full rationale). Original run: training/train_segformer_b2.sh, job 1673,
# 0.4344 mean IoU under the broken ratio channel + stale normalization stats.
